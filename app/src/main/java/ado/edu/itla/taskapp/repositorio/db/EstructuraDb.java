...
public class EstructuraDb {
    ...
    public static final String TABLA_USUARIO = "CREATE TABLE IF NOT EXISTS usuario ( id INTEGER PRIMARY KEY AUTOINCREMENT, nombre TEXT, email TEXT, contrasena TEXT, tipoUsuario TEXT)";
